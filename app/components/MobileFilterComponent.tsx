...
const MobileFilterComponent = ({
  ...
  return (
    <>
      ...
      ></div>
      <div
        className={`fixed inset-x-0 bottom-0 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-gray-100 text-black'} p-4 rounded-t-lg shadow-lg z-40 transform transition-transform duration-300 ${
